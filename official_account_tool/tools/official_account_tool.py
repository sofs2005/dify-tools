...
from tools.official_account_publisher import OfficialAccountPublisher

class OfficialAccountTool(Tool):
    ...
    def _invoke(self, tool_parameters: dict[str, Any]) -> Generator[ToolInvokeMessage, None, None]:
        ...
        token_service_url = tool_parameters.get('token_service_url')
        ...
        try:
            publisher = OfficialAccountPublisher(app_id, app_secret, token_service_url)
